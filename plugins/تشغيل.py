...
@Client.on_message(command2(["شغل","تشغيل"])
    & filters.group
    & ~filters.edited
    & ~filters.forwarded
    & ~filters.via_bot
...
@Client.on_message(command2(["ايقاف","ايقاف مؤقت"]) & other_filters)
@errors
...
@Client.on_message(command2(["استمرار","استئناف"]) & other_filters)
@errors
@authorized_users_only
...
@Client.on_message(command2(["المطور","المبرمج","مبرمج","مطور"]) & filters.group & ~filters.edited)
