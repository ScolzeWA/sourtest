...
OWNER_USERNAME = getenv("OWNER_USERNAME", "WORLD_MUSIC_F")
STRING_SESSION = getenv("STRING_SESSION", "session")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1491415522 1419419100 2112059230").split()))
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/gr_world_music")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "https://t.me/ch_world_music")

# 𝐃𝐨 𝐍𝐨𝐭 𝐂𝐡𝐚𝐧𝐠𝐞 𝐓𝐡𝐢𝐬 𝐋𝐢𝐧𝐞𝐬 // 𝐈𝐠𝐧𝐨𝐫𝐞 𝐓𝐡𝐢𝐬 (𝐙𝐄𝐔𝐒 𝐎𝐏) 
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
PROFILE_CHANNEL = getenv("PROFILE_CHANNEL", "https://t.me/ch_world_music")
